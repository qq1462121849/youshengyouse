    ...
    <div class="dayingDetail" v-if="data">
      <div class="listBox">
        <div class="author">
          ...
          <div class="other">
            <div @click="vueJumpTo('/comment?id=' + data.dry_id)">
      ...
      <div class="publish" @click="vueJumpTo('/comment?id=' + data.dry_id)"><img src="../../assets/img/home/publish.png" alt="">发表评论</div>
      <div v-transfer-dom>
...
export default {
  ...
  methods: {
    detail () {
      ...
      dsBridge.call('openGood', this.data.goodsInfo)
    },
    share (item) {
