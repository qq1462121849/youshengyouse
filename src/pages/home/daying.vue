<template>
    <div class="daying">
      <x-header :left-options="{showBack: false}"><a slot="left" @click="vueGoBack()"  class="backBox">
      ...
      <div class="desc">
        ...
        <div class="imgBox">
          <div class="imgs" v-for="(item, index) of imgs" :key="index" :style="{backgroundImage: 'url(' + item +')'}">
            <img :src="item" alt="">
            <img src="../../assets/img/home/close.png" alt="" class="closeBtn" @click="del(index)"></div>
          <div class="imgs" @click="show = true"><img src="../../assets/img/home/addImg.png" alt="" class="thumb"></div>
        </div>
      </div>
      <div class="select" @click="vueJumpTo('dayingShop')" style="font-size: .26rem;">选择商品</div>
...
export default {
  ...
  activated () {
    ...
    console.log('shop', this.shop.title)
  }
}
</script>
<style lang="less">
